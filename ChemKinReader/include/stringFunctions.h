...
namespace IO
{
   ...
   void splitString(const std::string& str, std::vector<std::string>& v, const char* delims);

//    void tokenizeString(const std::string& in_val, std::vector<std::string>& v);
    
    std::string trimCopy(const std::string& strwithspaces);

    std::string eraseAll(const std::string& str, const std::string& chr);
