...
namespace IO
{
    ...
    class Reaction
    {
        ...
        bool flagThirdBody_;
        bool flagLOW_, flagTROE_, flagSRI_, flagTROE_center_;
        ...
        std::vector<double> LOW_, TROE_, SRI_, TROE_center_;
    ...
    public:
        ...
        void setTROE_center(const std::vector<double>& TROE_center);
        const std::vector<double>& getTROE_center() const;
        const bool& hasTROE_center() const;
