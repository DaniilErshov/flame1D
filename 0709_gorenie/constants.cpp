...
void init_consts(const string& chemfile, const string& thermfile, const string& transfile, int& num_gas_species, int& num_react) {
    std::string name_file = R"(..\kinetics\n-heptane-tran.out)";
    std::string cond_str = "CONDUCTIVITIES";
    std::string visc_str = "VISCOSITIES";
    std::string diff_str = "DIFFUSION";

    //const std::string chemfile = R"(..\kinetics\heptane.inp)";
    //const std::string thermfile = R"(..\kinetics\term.dat)";
    //const std::string transfile = R"(..\kinetics\tran.dat)";

    //const std::string chemfile = R"(..\kinetics\YOO_kinetics\heptane_YO_forw.inp)";
    //const std::string thermfile = R"(..\kinetics\YOO_kinetics\therm_YOO.dat)";
    //const std::string transfile = R"(..\kinetics\YOO_kinetics\tran_YOO.dat)";
