...
set_target_properties(SUNDIALS::nvecopenmp_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/sundials_nvecopenmp.lib"
  )
...
# Import target "SUNDIALS::nvecopenmp_shared" for configuration "Debug"
set_property(TARGET SUNDIALS::nvecopenmp_shared APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(SUNDIALS::nvecopenmp_shared PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/sundials_nvecopenmp.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/sundials_nvecopenmp.dll"
  )
